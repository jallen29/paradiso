...
--------------------- CSS Credits "Foodeez Lite WordPress Theme" ---------------------
...
= 1.0.4 =
* Now Compatible with WordPress latest Version (4.0.0).
* Added left sidebar Page Template.
* Removed default link of RESERVATION button.

= 1.0.3 =
* Removed default follow icon show settings.
