      ...
      foreach( (array) $this->options as $option ) {
        ...
        foreach( (array) $this->get_pages( $option ) as $page ) {
          ...
          if ( ! isset( $page['hidden_page'] ) && $screen->id == $this->page_hook[$page['id']] ) {
           ...
           $sktlink = "http://www.sketchthemes.com/themes/foodeez-multi-cuisine-restaurant-wordpress-theme/";
       $sktratelink = "http://wordpress.org/support/view/theme-reviews/foodeez-lite";
            $skttest_drive = "http://trial.sketchthemes.com/wp-signup.php";
            
            echo '  <div class="donate-info">
          <strong>'. __( "To Activate All Features, Please Upgrade to Pro version!", "foodeez-lite" ) .'</strong><br/>
          <a title="'. __( "Upgrade to Pro", "foodeez-lite" ) .'" href="'. esc_url($sktlink) .'" target="_blank" class="upgrade">'. __( "Upgrade to Pro", "foodeez-lite" ) .'</a> <a title="'. __( 'Setup Instructions', 'foodeez-lite' ) .'" href="'. get_template_directory_uri().'/Installation_Instructions.txt' .'" target="_blank" class="donate">'. __( 'Setup Instructions', 'foodeez-lite' ) .'</a>
          <a title="'. __( 'Rate Foodeez Lite', 'foodeez-lite' ) .'" href="'. esc_url($sktratelink) .'" target="_blank" class="review">'. __( 'Rate Foodeez Lite', 'foodeez-lite' ) .'</a>
          <a title="'. __( 'Test Drive', 'foodeez-lite' ) .'" href="'. esc_url($skttest_drive) .'" target="_blank" class="review">'. __( 'Theme Test Drive', 'foodeez-lite' ) .'</a>
          <div id="social-share">
          <div class="fb-like">
        ...
        <div class="clearfix"></div>
              ...
              echo '<div id="option-tree-header-wrap">';
                ...
                echo '<ul id="option-tree-header">';
                  ...
                  echo '<li id="option-tree-version"><span>Version ' . FOODEEZ_LITE_THEME_VERSION . '</span></li>';
