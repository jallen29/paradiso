		...
		<div class="row">
		  <div class="col-md-8">
			<div class="row">
			  <div id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
				   ...
				   <h1><a href="<?php the_permalink(); ?>" title="<?php the_title_attribute(); ?>"><?php 
					...
					<p class="kt-price"><?php _e('Price: ', 'italianrestaurant'); echo get_post_meta($post->ID, 'ketchupthemes_price', true); ?></p>
					<?php endif; ?>
				  </div>
				  <?php endif; endwhile; else: ?>
				  <p class="kt-white"><?php _e('Sorry, no posts matched your criteria.', 'italianrestaurant'); ?></p>
				  <?php endif; ?>
			...
			<div id="kt-pagination">
				<div class="alignleft"><?php previous_posts_link(__( '&laquo; Newer posts', 'italianrestaurant' )) ?></div>
				<div class="alignright"><?php next_posts_link(__( 'Older posts &raquo;', 'italianrestaurant' )) ?></div>
			</div>
		  </div>
		  <?php get_sidebar(); ?>
		</div>
